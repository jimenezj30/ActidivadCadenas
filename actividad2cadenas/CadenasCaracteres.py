...
#2 len sirve para contar las letras del nombre, .replace(_old:"",_new: "" ) excluye los espacios del nombre
FullName = "Luis Alfonso Vejarano"
FullName_sin_espacios = FullName.replace(" ", "")
lengthUsuario = len(FullName_sin_espacios)
